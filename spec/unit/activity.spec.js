  ...
  describe("addressing", function () {
    it("gets actor and object addresses from custom collections", async function () {
      ...
      const act = await apex.buildActivity(
        "Create",
        testUser.id,
        "https://localhost/u/test/c/besties"
      );
      nock("https://mocked.com")
        .get("/u/bob")
        .reply(200, {
          id: "https://mocked.com/u/bob",
          inbox: ["https://mocked.com/u/bob/inbox"],
        })
        .get("/u/sally")
        .reply(200, {
          id: "https://mocked.com/u/sally",
          inbox: ["https://mocked.com/u/sally/inbox"],
        });
